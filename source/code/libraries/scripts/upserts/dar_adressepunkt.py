...
def convert_upsert(create_table_if_not_exist=False):
    ...
    file_name = "DAR_Adressepunkt_1.json"
    columns_to_keep = {
        'id_lokalId': 'id',
        'position': 'pos',
        'oprindelse_kilde': 'oprindelse_kilde',
        'oprindelse_nøjagtighedsklasser': 'oprindelse_nojagtighedsklasser',
        'oprindelse_registrering': 'oprindelse_registrering',
        'oprindelse_tekniskStandard': 'oprindelse_teknisk_standard',
    ...
    table_name='dar_adressepunkt'
    fields_dict = {
        'id': {"type": TEXT(), "primary_key": True, "autoincrement": False},
        'pos': {"type": TEXT()},
        'oprindelse_kilde': {"type": TEXT()},
        'oprindelse_nojagtighedsklasser': {"type": TEXT()},
        'oprindelse_registrering': {"type": TEXT()},
        'oprindelse_teknisk_standard': {"type": TEXT()},
