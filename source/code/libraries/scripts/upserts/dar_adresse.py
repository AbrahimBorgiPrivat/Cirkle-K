...
def convert_upsert(create_table_if_not_exist=False):
    ...
    file_name = "DAR_Adresse_1.json"
    columns_to_keep = {
        'id_lokalId': 'id',
        'adressebetegnelse': 'adressebetegnelse',
        'dørbetegnelse': 'dorbetegnelse',
        'dørpunkt': 'dorpunkt',
        'etagebetegnelse': 'etagebetegnelse',
        'bygning': 'bygningid',
    ...
    table_name='dar_adresse'
    fields_dict = {
        'id': {"type": TEXT(), "primary_key": True, "autoincrement": False},
        'adressebetegnelse': {"type": TEXT()},
        'dorbetegnelse': {"type": TEXT()},
        'dorpunkt': {"type": TEXT()},
        'etagebetegnelse': {"type": TEXT()},
        'bygningid': {"type": TEXT()},
        'husnummerid': {"type": TEXT()},
