...
from libraries.utils.db_types import BIGINT, TEXT, TIMESTAMP
...
def convert_upsert(create_table_if_not_exist=False):
    file_path = JSON_DIR
    file_name = "DAGI_Kommuneinddeling_1.json"
    columns_to_keep = {
        'id_lokalId': 'id',
        'feltliste': 'feltliste',
        'navn': 'navn',
        ...
        'gmlId': 'gml_id',
        'DAGIid': 'dag_id',
        'LAU1vaerdi': 'lau_1_vaerdi',
        'id_namespace': 'id_namespace',
        'kommunekode': 'kommunekodeid',
        'udenforKommuneinddeling': 'udenfor_kommuneinddeling',
        'regionLokalId': 'region_lokal_id',
        'landekode': 'landekode',
        'skala': 'skala',
    ...
    fields_dict = {
        ...
        'gml_id': {"type": TEXT()},
        'dag_id': {"type": TEXT()},
        'lau_1_vaerdi': {"type": TEXT()},
        'id_namespace': {"type": TEXT()},
        'kommunekodeid': {"type": TEXT()},
        'udenfor_kommuneinddeling': {"type": TEXT()},
        'region_lokal_id': {"type": BIGINT()},
        'landekode': {"type": TEXT()},
        'skala': {"type": TEXT()},
    ...
    logger.info("Data from %s has been inserted/updated in %s.%s.", file_name, schema_name, table_name)
    return insert_data
