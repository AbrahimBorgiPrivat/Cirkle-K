...
$modelPath = Join-Path $workspaceRoot 'Circle K Interview.SemanticModel\definition\database.tmdl'
...
$scripts = @(
    "$scriptsBase\Measures\KPI_MEASURES\KPI_MEASURES.csx",
    "$scriptsBase\Measures\VISUAL_MEASURES\VISUAL_MEASURES.csx"
)
